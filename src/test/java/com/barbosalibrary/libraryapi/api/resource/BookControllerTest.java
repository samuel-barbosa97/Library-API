...
public class BookControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar resource not found quando o livre procurado não existir.")
    ...
    public void inexistentBookTest() throws Exception {
